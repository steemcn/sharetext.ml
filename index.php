...
<div class="container">
	<div class="panel panel-success" align="center">
		<div class="panel-heading">
			...
			- 
			<small>
				The easy way to share textfiles!
			</small>
		</div>
		<div class="panel-body">
			<h4>ShareText.ml is a free service that let you create textfiles to share with friends and family in seconds!</h4>
			<h4>It is really simple to use! Just click the button below to get started!</h4>
			<br>
